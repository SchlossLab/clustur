test_that("get_count_table returns the count table", {
  ...
  count_table_sparse <- read_count(test_path("extdata", "amazon_sparse.count_table"))
  distance_data <- read_dist(test_path("extdata", "amazon_column.dist"), count_table_sparse, cutoff, FALSE)
