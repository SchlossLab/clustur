...
test_that("Normal Cluster is able to properly cluster data", {
  ...
  cluster_furthest <- cluster(sparse_matrix, 0.2,
                              "furthest", count_table, FALSE)
  cluster_average <- cluster(sparse_matrix, 0.2,
                             "average", count_table, FALSE)
  cluster_weighted <- cluster(sparse_matrix, 0.2,
                              "weighted", count_table, FALSE)
  cluster_nearest <- cluster(sparse_matrix, 0.2,
