...
context("Cluster algorithms") {
  ...
  test_that("Get Tag returns the tag that corresponds to the clustering type") {
    ...
    auto* clustComplete = new CompleteLinkage(abund, &listVector,
    ...
    auto* clustSingle = new SingleLinkage(abund, &listVector,
    ...
    auto* clustAverage = new AverageLinkage(abund, &listVector,
    ...
    auto* clustWeighted = new WeightedLinkage(abund, &listVector,
    ...
    test_that("Get Tag returns the tag that corresponds to the clustering type") {
      ...
      ListVector listVector = adapter.CreateListVector();
      RAbundVector* abund = new RAbundVector();
      auto* clust = new SingleLinkage(abund, &listVector,
          &dMatrix, 0.2, "nearest", -1);
