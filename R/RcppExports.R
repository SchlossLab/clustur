...
WriterPhylipFile <- function(xPosition, yPosition, data, cutoff, saveLocation) {
    invisible(.Call(`_Opticluster_WriterPhylipFile`, xPosition, yPosition, data, cutoff, saveLocation))
}
